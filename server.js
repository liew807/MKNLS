...
// 5. 管理员删除秘钥 - 对应前端的 handleDeleteKey
...
// 6. 清理过期秘钥 - 对应前端的 handleCleanupExpiredKeys
...
// 7. 修改邮箱接口 - 对应前端的 handleChangeEmail
...
// 8. 修改密码接口 - 对应前端的 handleChangePassword
...
// 9. 设置国王等级接口 - 对应前端的 handleKingRank
